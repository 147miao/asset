...
public class AssetServiceImpl extends ServiceImpl<AssetMapper, Asset> implements AssetService {
    ...
    @Override
    public PageResult<Asset> selectPage(Integer pageNum, Integer pageSize, String assetName, String assetType, String category, String status, Long projectId) {
        ...
        wrapper.like(StrUtil.isNotBlank(assetName), Asset::getAssetName, assetName)
                ...
                .eq(StrUtil.isNotBlank(category), Asset::getCategory, category)
    ...
    public void exportAssets(Long projectId, HttpServletResponse response) {
        ...
        writer.addHeaderAlias("category", "资产分类");
