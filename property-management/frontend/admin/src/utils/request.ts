...
const logger = {
  debug: (...args: unknown[]) => LOG_ENABLED && ['debug', 'info', 'warn', 'error'].includes(LOG_LEVEL) && console.log('[DEBUG]', new Date().toISOString(), ...args),
  info: (...args: unknown[]) => LOG_ENABLED && ['info', 'warn', 'error'].includes(LOG_LEVEL) && console.info('[INFO]', new Date().toISOString(), ...args),
  warn: (...args: unknown[]) => LOG_ENABLED && ['warn', 'error'].includes(LOG_LEVEL) && console.warn('[WARN]', new Date().toISOString(), ...args),
  error: (...args: unknown[]) => LOG_ENABLED && ['error'].includes(LOG_LEVEL) && console.error('[ERROR]', new Date().toISOString(), ...args),
  logRequest: (config: RequestConfig) => {
